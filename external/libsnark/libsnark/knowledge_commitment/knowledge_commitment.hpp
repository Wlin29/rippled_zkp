...
struct knowledge_commitment {
    ...
    knowledge_commitment& operator=(knowledge_commitment<T1,T2> &&other) = default;
    knowledge_commitment operator+(const knowledge_commitment<T1, T2> &other) const;
    knowledge_commitment mixed_add(const knowledge_commitment<T1, T2> &other) const;
    knowledge_commitment dbl() const;
